                ...
                <div class="flex items-center gap-2">
                    ...
                    @auth
                        ...
                        <div class="relative group">
                            ...
                            <span class="absolute hidden w-20 px-1 py-1 mb-2 text-xs text-center text-white transform -translate-x-1/2 bg-gray-800 rounded-md left-1/2 bottom-full group-hover:block">
                                Edit Profile
                            </span>
                        </div>
